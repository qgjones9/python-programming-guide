...
Local notes on **1.1. A Simple Example** within [*1. Extending Python with C or C++*](https://docs.python.org/3/extending/extending.html).

- Detailed rules: **[1.1. A Simple Example](https://docs.python.org/3/extending/extending.html#a-simple-example)**.
