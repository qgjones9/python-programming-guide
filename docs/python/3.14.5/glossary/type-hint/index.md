...
An [annotation](../annotation/index.md) that specifies the expected type for a variable, a class
attribute, or a function parameter or return value.

Type hints are optional and are not enforced by Python but
they are useful to [static type checkers](../static-type-checker/index.md).
They can also aid IDEs with code completion and refactoring.

Type hints of global variables, class attributes, and functions,
but not local variables, can be accessed using
[typing.get_type_hints()](https://docs.python.org/3.14/library/typing.html#typing.get_type_hints).
