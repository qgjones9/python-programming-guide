...
to implement the [Loader](https://docs.python.org/3.14/library/importlib.html#importlib.abc.Loader) interface.
A loader is typically returned by a [finder](../finder/index.md).
See also:
