...
often results from [race conditions](../race-condition/index.md) where the
relative timing or interleaving of threads affects the result.
Proper synchronization using [locks](../lock/index.md) and other
[synchronization primitives](../synchronization-primitive/index.md) helps
