...
Local notes on **Allocator Domains**, part of [*Memory Management*](https://docs.python.org/3/c-api/memory.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/memory.html#allocator-domains)** for exact signatures, deprecation notes, and edge cases.
