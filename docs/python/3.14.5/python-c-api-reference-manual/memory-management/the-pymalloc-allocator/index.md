...
Local notes on **The pymalloc allocator**, part of [*Memory Management*](https://docs.python.org/3/c-api/memory.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/memory.html#the-pymalloc-allocator)** for exact signatures, deprecation notes, and edge cases.
