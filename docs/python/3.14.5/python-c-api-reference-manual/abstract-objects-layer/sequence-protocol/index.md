...
Local notes on **Sequence Protocol**, part of [*Abstract Objects Layer*](https://docs.python.org/3/c-api/abstract.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/sequence.html)** for exact signatures, deprecation notes, and edge cases.
