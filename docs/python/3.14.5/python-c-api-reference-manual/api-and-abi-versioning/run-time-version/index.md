...
Local notes on **Run-time version**, part of [*API and ABI Versioning*](https://docs.python.org/3/c-api/apiabiversion.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/apiabiversion.html#run-time-version)** for exact signatures, deprecation notes, and edge cases.
