...
Local notes on **Data marshalling support**, part of [*Utilities*](https://docs.python.org/3/c-api/utilities.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/marshal.html)** for exact signatures, deprecation notes, and edge cases.
