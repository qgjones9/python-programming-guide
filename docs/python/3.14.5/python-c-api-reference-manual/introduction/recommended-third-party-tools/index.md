...
Local notes on **Recommended third party tools**, part of [*Introduction*](https://docs.python.org/3/c-api/intro.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/intro.html#recommended-third-party-tools)** for exact signatures, deprecation notes, and edge cases.
