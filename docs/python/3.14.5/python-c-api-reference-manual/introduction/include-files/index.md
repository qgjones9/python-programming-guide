...
Local notes on **Include Files**, part of [*Introduction*](https://docs.python.org/3/c-api/intro.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/intro.html#include-files)** for exact signatures, deprecation notes, and edge cases.
