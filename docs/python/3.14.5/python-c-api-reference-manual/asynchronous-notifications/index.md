# [Asynchronous notifications](https://docs.python.org/3/c-api/threads.html#asynchronous-notifications)

Single-page chapter in [**Asynchronous notifications**](https://docs.python.org/3/c-api/threads.html#asynchronous-notifications); no subdivisions below in this mirror.
Skim overview bullets here, follow the canonical link for the full narrative and API listings.

- Canonical: [Asynchronous notifications](https://docs.python.org/3/c-api/threads.html#asynchronous-notifications)
