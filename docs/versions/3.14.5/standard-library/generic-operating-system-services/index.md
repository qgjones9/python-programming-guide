...
Related material: [`pathlib`](../file-and-directory-access/pathlib-object-oriented-filesystem-paths/index.md) and [`shutil`](../file-and-directory-access/shutil-high-level-file-operations/index.md) for higher-level file work; [`subprocess`](../subprocess-management/subprocess-subprocess-management/index.md) for spawning processes; [`sys`](../python-runtime-services/sys-system-specific-parameters-and-functions/index.md) for interpreter parameters.
