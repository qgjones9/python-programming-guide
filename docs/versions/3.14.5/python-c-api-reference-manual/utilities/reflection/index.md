...
Local notes on **Reflection**, part of [*Utilities*](https://docs.python.org/3/c-api/utilities.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/reflection.html)** for exact signatures, deprecation notes, and edge cases.
