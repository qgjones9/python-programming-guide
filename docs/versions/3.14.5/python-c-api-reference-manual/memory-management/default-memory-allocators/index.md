...
Local notes on **Default Memory Allocators**, part of [*Memory Management*](https://docs.python.org/3/c-api/memory.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/memory.html#default-memory-allocators)** for exact signatures, deprecation notes, and edge cases.
