...
Local notes on **tracemalloc C API**, part of [*Memory Management*](https://docs.python.org/3/c-api/memory.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/memory.html#tracemalloc-c-api)** for exact signatures, deprecation notes, and edge cases.
