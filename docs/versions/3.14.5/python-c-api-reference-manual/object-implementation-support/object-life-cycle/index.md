...
Local notes on **Object Life Cycle**, part of [*Object Implementation Support*](https://docs.python.org/3/c-api/objimpl.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/lifecycle.html)** for exact signatures, deprecation notes, and edge cases.
