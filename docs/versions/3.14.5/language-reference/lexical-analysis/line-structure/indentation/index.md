...
- You may use spaces or tabs for indentation, but **do not mix spaces and tabs** within the same block—if Python detects ambiguous or inconsistent mixing, it raises a [TabError](../../../../standard-library/built-in-exceptions/concrete-exceptions/taberror/index.md).
