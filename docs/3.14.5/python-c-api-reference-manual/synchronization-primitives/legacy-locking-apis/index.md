...
Local notes on **Legacy locking APIs**, part of [*Synchronization primitives*](https://docs.python.org/3/c-api/synchronization.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/synchronization.html#legacy-locking-apis)** for exact signatures, deprecation notes, and edge cases.
