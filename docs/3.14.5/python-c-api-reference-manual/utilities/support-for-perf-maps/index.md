...
Local notes on **Support for Perf Maps**, part of [*Utilities*](https://docs.python.org/3/c-api/utilities.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/perfmaps.html)** for exact signatures, deprecation notes, and edge cases.
