...
Local notes on **Character classification and conversion**, part of [*Utilities*](https://docs.python.org/3/c-api/utilities.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/conversion.html#character-classification-and-conversion)** for exact signatures, deprecation notes, and edge cases.
