...
Single-page chapter in [**Monitoring C API**](https://docs.python.org/3/c-api/monitoring.html); no subdivisions below in this mirror.
Skim overview bullets here, follow the canonical link for the full narrative and API listings.

- Canonical: [Monitoring C API](https://docs.python.org/3/c-api/monitoring.html)
