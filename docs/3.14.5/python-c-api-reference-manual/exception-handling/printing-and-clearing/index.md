...
Local notes on **Printing and clearing**, part of [*Exception Handling*](https://docs.python.org/3/c-api/exceptions.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/exceptions.html#printing-and-clearing)** for exact signatures, deprecation notes, and edge cases.
