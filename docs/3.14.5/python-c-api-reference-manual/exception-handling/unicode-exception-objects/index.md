...
Local notes on **Unicode Exception Objects**, part of [*Exception Handling*](https://docs.python.org/3/c-api/exceptions.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/exceptions.html#unicode-exception-objects)** for exact signatures, deprecation notes, and edge cases.
