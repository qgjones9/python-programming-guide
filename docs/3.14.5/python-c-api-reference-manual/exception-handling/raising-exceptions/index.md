...
Local notes on **Raising exceptions**, part of [*Exception Handling*](https://docs.python.org/3/c-api/exceptions.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/exceptions.html#raising-exceptions)** for exact signatures, deprecation notes, and edge cases.
