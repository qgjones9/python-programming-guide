...
Local notes on **Py_GetArgcArgv()**, part of [*Python Initialization Configuration*](https://docs.python.org/3/c-api/init_config.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/init_config.html#py-getargcargv)** for exact signatures, deprecation notes, and edge cases.
