...
Local notes on **Thread-specific storage API**, part of [*Thread-local storage support*](https://docs.python.org/3/c-api/tls.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/tls.html#thread-specific-storage-api)** for exact signatures, deprecation notes, and edge cases.
