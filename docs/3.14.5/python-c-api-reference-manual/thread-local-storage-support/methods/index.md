...
Local notes on **Methods**, part of [*Thread-local storage support*](https://docs.python.org/3/c-api/tls.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/tls.html#methods)** for exact signatures, deprecation notes, and edge cases.
