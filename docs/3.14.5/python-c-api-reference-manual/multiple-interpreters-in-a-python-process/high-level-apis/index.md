...
Local notes on **High-level APIs**, part of [*Multiple interpreters in a Python process*](https://docs.python.org/3/c-api/subinterpreters.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/subinterpreters.html#high-level-apis)** for exact signatures, deprecation notes, and edge cases.
