...
Local notes on **Advanced debugger support**, part of [*Multiple interpreters in a Python process*](https://docs.python.org/3/c-api/subinterpreters.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/subinterpreters.html#advanced-debugger-support)** for exact signatures, deprecation notes, and edge cases.
