...
Local notes on **The mimalloc allocator**, part of [*Memory Management*](https://docs.python.org/3/c-api/memory.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/memory.html#the-mimalloc-allocator)** for exact signatures, deprecation notes, and edge cases.
