...
Local notes on **Memory Interface**, part of [*Memory Management*](https://docs.python.org/3/c-api/memory.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/memory.html#memory-interface)** for exact signatures, deprecation notes, and edge cases.
