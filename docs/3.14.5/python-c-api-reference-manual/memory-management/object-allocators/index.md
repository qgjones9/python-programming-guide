...
Local notes on **Object allocators**, part of [*Memory Management*](https://docs.python.org/3/c-api/memory.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/memory.html#object-allocators)** for exact signatures, deprecation notes, and edge cases.
