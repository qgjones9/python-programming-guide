...
Local notes on **Build-time version constants**, part of [*API and ABI Versioning*](https://docs.python.org/3/c-api/apiabiversion.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/apiabiversion.html#build-time-version-constants)** for exact signatures, deprecation notes, and edge cases.
...
Parent: [API and ABI Versioning](../index.md)
