...
Local notes on **Cautions about fork()**, part of [*Thread states and the global interpreter lock*](https://docs.python.org/3/c-api/threads.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/threads.html#cautions-about-fork)** for exact signatures, deprecation notes, and edge cases.
