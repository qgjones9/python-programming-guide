...
Local notes on **Managing the Monitoring State**, part of [*Generating Execution Events*](https://docs.python.org/3/c-api/monitoring.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/monitoring.html#managing-the-monitoring-state)** for exact signatures, deprecation notes, and edge cases.
...
Parent: [Generating Execution Events](../index.md)
