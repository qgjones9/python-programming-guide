...
Local notes on **Objects, Types and Reference Counts**, part of [*Introduction*](https://docs.python.org/3/c-api/intro.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/intro.html#objects-types-and-reference-counts)** for exact signatures, deprecation notes, and edge cases.
