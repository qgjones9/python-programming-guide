...
Local notes on **Initialization function**, part of [*Defining extension modules*](https://docs.python.org/3/c-api/extension-modules.html). This page summarizes patterns; authoritative text stays upstream.

- Follow the **[official section](https://docs.python.org/3/c-api/extension-modules.html#initialization-function)** for exact signatures, deprecation notes, and edge cases.
