...
This hub lists every algorithm page in this section. Each page opens with a short table: what the algorithm does, the core idea, and typical complexity (where it matters most).

| Topic | What it is | Page |
| --- | --- | --- |
| Selection sort | Grows a sorted front by picking the next smallest (or largest) from the rest. | [Selection sort](selection-sort/index.md) |
| Insertion sort | Inserts each element into its place in a growing sorted region. | [Insertion sort](insertion-sort/index.md) |
